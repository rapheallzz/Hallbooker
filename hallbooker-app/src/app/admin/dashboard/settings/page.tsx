        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-start py-6 border-b border-gray-200 last:border-b-0">
            ...
            <div className="md:col-span-2 flex items-center space-x-4">
                <input
                    ...
                    className="flex-grow w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-primary-focus text-gray-600"
