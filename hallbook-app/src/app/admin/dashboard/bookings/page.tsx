...
const BookingsPage = () => {
  ...
  const [selectedHall, setSelectedHall] = useState(hallIdFromUrl || '');
  ...
  const fetchBookings = async () => {
    ...
    try {
      ...
      if (bookingsRes.data && bookingsRes.data.data) {
        const bookingsData = Array.isArray(bookingsRes.data.data) ? bookingsRes.data.data : bookingsRes.data.data.bookings;
